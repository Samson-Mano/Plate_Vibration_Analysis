...
public:
	...
	void add_text(const int& label_id, std::string& label, glm::vec3& label_loc, glm::vec3& label_color);
	void update_text(const int& label_id, std::string& label, glm::vec3& label_loc, glm::vec3& label_color);
