...
void rslt_elementtri_list_store::init(geom_parameters* geom_param_ptr, obj_mesh_data* mesh_data)
{
...
void rslt_elementtri_list_store::add_rslt_elementtriangle(int& tri_id, rslt_node_store* nd1, rslt_node_store* nd2, rslt_node_store* nd3)
{
	...
	mesh_data->add_mesh_tris(tri_id, (*nd1).node_id, (*nd2).node_id, (*nd3).node_id);
