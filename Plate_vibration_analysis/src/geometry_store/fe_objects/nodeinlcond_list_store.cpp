...
void nodeinlcond_list_store::set_zero_condition(int inlcond_type, const int& model_type)
{
	...
	if (inlcond_type == 0)
	{
		...
		inlcond_points.set_point_color(geom_param_ptr->geom_colors.inlcond_displ_color);
		inlcond_lines.set_line_color(geom_param_ptr->geom_colors.inlcond_displ_color);

	}
	else
	{
		// Velocity initial condition
		inlcond_points.set_point_color(geom_param_ptr->geom_colors.inlcond_velo_color);
		inlcond_lines.set_line_color(geom_param_ptr->geom_colors.inlcond_velo_color);
